 ...
 *   already applied the same swap/restore).
 ...
 * freshness and must NOT trigger a reload. The substitute and restore paths
 * of the swap panel share this one predicate; user-facing copy that promises
