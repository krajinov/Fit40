 ...
 *   already applied the same swap/restore) and `ADJUSTMENT_NO_CHANGE`
 *   (another tab already applied the same skip/unskip, M10).
 ...
 * and unskip paths share this one predicate; user-facing copy that promises
 * a reload ("Reloading the latest state…") is only allowed for codes listed
 * here.
 */
