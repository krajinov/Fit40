 ...
 * and the regression floor in `exercise-progression-increments.test.ts`; the
 * history-window semantics (ordering, two-occurrence regress) in
 * `exercise-progression-history-window.test.ts`.
 *
 * Unless a scenario states otherwise, the history window holds a single
 * occurrence — the shape the v1 engine consumed. The two-occurrence
 * regression rule (v2) needs a second below-minimum prior occurrence to
 * regress, so regress rows carry two entries.
 */
...
const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    history: [performance(threeByTenToTwelve, [
      repSet(1, 12, 12),
      repSet(2, 12, 12),
      repSet(3, 12, 12),
    ])],
  ...
  },
  {
    ...
    history: [performance(twoByTenToTwelve, [repSet(1, 12, 15), repSet(2, 12, 15)])],
    expected: {
      basis: 'increase',
      reason: 'all-sets-at-top-of-range',
      previousLoadKg: 15,
  ...
  },
  {
    ...
    history: [performance(threeByEightToTwelve, [repSet(1, 12, 50), repSet(2, 12, 50)])],
    expected: {
      basis: 'hold',
  ...
  {
    name: 'holds the load when every set is exactly minReps',
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTen,
    history: [performance(threeByEightToTen, [
      repSet(1, 8, 20),
  ...
  },
  {
    ...
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTwelve,
    history: [performance(threeByEightToTwelve, [
      repSet(1, 10, 50),
      repSet(2, 10, 50),
      repSet(3, 7, 50),
    ])],
  ...
  {
    name: 'holds after a single below-minimum session: 7/7/7 in 3x8-12 with no prior history',
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTwelve,
    history: [performance(threeByEightToTwelve, [
      repSet(1, 7, 50),
  ...
  {
    name: 'holds after a single below-minimum session even when an older below-minimum occurrence exists under a different scheme',
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTwelve,
    history: [
      performance(threeByEightToTwelve, [
        repSet(1, 7, 50),
        repSet(2, 7, 50),
        repSet(3, 7, 50),
      ]),
      allBelowMinimum(threeByEightToTen, 50),
    ],
    expected: {
      basis: 'hold',
      reason: 'single-session-below-minimum',
  ...
  {
    name: 'regresses when the two newest eligible occurrences are both below minReps: 7/7/7 twice in 3x8-12',
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTwelve,
    history: [
      performance(threeByEightToTwelve, [
  ...
  },
  {
    ...
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTwelve,
    history: [performance(threeByEightToTwelve, [repSet(1, 10, 50), repSet(2, 9, 50)])],
    expected: {
      basis: 'hold',
      reason: 'incomplete-sets',
      previousLoadKg: 50,
  ...
  },
  {
    ...
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTwelve,
    history: [performance(threeByEightToTwelve, [repSet(1, 7, 50), repSet(2, 7, 50)])],
    expected: {
      basis: 'hold',
      reason: 'incomplete-sets',
      previousLoadKg: 50,
  ...
  },
  {
    ...
    equipment: EquipmentType.Barbell,
    prescription: threeByEightToTwelve,
    history: [performance(threeByEightToTwelve, [repSet(1, 7, 50)])],
    expected: {
      basis: 'hold',
      reason: 'incomplete-sets',
      previousLoadKg: 50,
